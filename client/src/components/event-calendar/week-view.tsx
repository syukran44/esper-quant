...
import { WeekCellsHeight } from "#/components/event-calendar/constants.ts";
...
import { useCurrentTimeIndicator } from "#/components/event-calendar/hooks/use-current-time-indicator.ts";
import type { CalendarEvent } from "#/components/event-calendar/types.ts";
import { isMultiDayEvent } from "#/components/event-calendar/utils.ts";
import {
  EndHour,
  StartHour,
